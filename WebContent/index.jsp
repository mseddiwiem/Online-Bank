...
<body>
	<div class="top-main">
		<div class="number">
			<h3><i class="fa fa-phone" aria-hidden="true"></i> +74 248 998</h3>
...
<section class="about" id="about">
	...
	<div class="about-heading">
		...
		<div class="col-md-6 about-right"></br> </br></br>
			<h3>TN Bank was a public-sector banking company headquartered in Tunisia. 
				<p>Presently, the bank has a network of 2,432</p>
			 <p>fully automated CBS branches and 4,724 branchless banking units across the country</p></h3>
			<div class="more">
